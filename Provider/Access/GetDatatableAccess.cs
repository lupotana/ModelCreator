...
{
    public static class GetDatatableAccess
    {
        ...
        public static void RetrieveColumnInformation()
        {
            ...
            {
                connection.Open();
                DataTable tables = connection.GetOleDbSchemaTable(OleDbSchemaGuid.Columns, null);
            ...
            if (dr != null)
            {
                ...
                while (dr.Read())
                {
                    if (!dr.GetString(0).Equals("dtproperties"))
                    {
                        ...
                        string columnsType = GetAccessType(columnsName, dr.GetString(2), columnsMaxLength, columnsNullable);
        ...
        public static string GetAccessType(string name, string tstrSqlType, int lenght, bool IsNullable)
        {
