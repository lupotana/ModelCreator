...
namespace ModelCreator
{
    ...
    {
        static ArrayList listBoolean = new ArrayList();

        public static void Add(string name)
        {
            listBoolean.Add(name);
        }
        ...
        public static string GetList()
        {
            ...
            foreach (string s in listBoolean)
            {
                sb.Append(list);
                sb.Append("\"");
                sb.Append(s);
    ...
    public class CreateClassSqlBase
    {
        public DataTable table = new DataTable();
        private string keyCode = string.Empty;
        public CreateClassSqlBase() { }
        ...
        public bool BuildTemplate(DataTable dt, Provider provider)
        {
            ...
            template = ManageTemplate.GetTemplate("CrudTemplateSqlBase.ico");
